...
<div class="content clearfix ">
    ...
    <div class="row features v2">
        ...
        $article1 = $pages->find('about-us/news/liberia-report');
        $url1     = $article1->url();
        $thumb1 = $article1->images()->find('article80.jpg');
        $article2 = $pages->find('about-us/news/halt-sida');
        $url2    = $article2->url();
        ...
        <div class="span4 featurecenter">
           <div class="row">
               ...
               <div class="span3">
                   <h3><a href="<?php echo $url1 ?>">LIBERIA SITE VISIT</a></h3>
